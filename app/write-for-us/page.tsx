...
export const metadata: Metadata = { title: "Write for Us — eLearning Tools", description: "Contribute a guest post to eLearning Tools. Share your expertise on online learning and education." };
...
`}</style>
      <div className="page-wrap">
        ...
        <p className="page-subtitle">We welcome guest contributors who can bring original insights and expertise to our readers. If you know online learning and education well, we'd love to publish your work.</p>
        <hr className="page-divider" />
        <h2>What We're Looking For</h2>
        <ul>
          <li>Original, well-researched articles on online learning and education</li>
        ...
        <h2>How to Pitch</h2>
        <p>Email us at <a href="mailto:hello@elearning-tools.com">hello@elearning-tools.com</a> with the subject line "Guest Post Pitch" and include:</p>
        <ul>
