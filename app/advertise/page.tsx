...
export const metadata: Metadata = { title: "Advertise — eLearning Tools", description: "Advertise with eLearning Tools and reach a targeted audience interested in online learning and education." };
...
`}</style>
      <div className="page-wrap">
        ...
        <h1 className="page-title">Advertise on eLearning Tools</h1>
        <p className="page-subtitle">Reach a highly engaged audience of readers actively researching and comparing online learning and education. Our visitors are decision-ready — they come here to find the best options.</p>
        ...
        <h2>Get in Touch</h2>
        <p>For pricing, media kit, and availability, contact us at <a href="mailto:hello@elearning-tools.com">hello@elearning-tools.com</a> with the subject line "Advertising Inquiry". We'll respond within 2 business days.</p>
      </div>
    </>
  );
}
