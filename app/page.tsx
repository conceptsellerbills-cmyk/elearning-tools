      ...
      <div className="container">
        ...
        <section className="section" style={{ paddingTop: 0 }}>
          ...
          <div className="category-grid">
            {([{"icon":"🏫","label":"Online Courses","desc":"Udemy, Coursera & alternatives","href":"/category/online-courses"},{"icon":"⚙️","label":"LMS Software","desc":"Moodle, Canvas & modern LMS","href":"/category/lms"},{"icon":"🎬","label":"Video Platforms","desc":"Hosting, streaming & live tools","href":"/category/video-platforms"},{"icon":"📝","label":"Quiz & Testing","desc":"Assessment and quiz builders","href":"/category/assessment"},{"icon":"🏆","label":"Certifications","desc":"Best certs for career growth","href":"/category/certifications"},{"icon":"🤖","label":"AI for Learning","desc":"AI tutors & adaptive learning","href":"/category/ai-learning"}] as {icon:string,label:string,desc:string,href:string}[]).map((c) => (
