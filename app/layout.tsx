...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/",
    types: {
      "application/rss+xml": [{ url: "/feed.xml", title: "eLearning Tools RSS Feed" }],
    },
  },
};
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en">
      <body>
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: `{"@context":"https://schema.org","@type":"WebSite","name":"eLearning Tools","url":"https://www.elearning-tools.com","potentialAction":{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"https://www.elearning-tools.com/all-articles?q={search_term_string}"},"query-input":"required name=search_term_string"}}` }} />
        <style>{`
          ...
          .footer-nl-form input:focus{border-color:#3b82f6}
          .footer-nl-form button{background:#3b82f6;color:#fff;border:none;border-radius:8px;padding:10px 20px;font-size:0.85rem;font-weight:700;cursor:pointer;white-space:nowrap;transition:opacity 0.15s}
          ...
          <div className="footer-inner">
            <div className="footer-grid">
              ...
              <div className="footer-col1">
                ...
                <p className="footer-desc">Reviews and comparisons of the best online learning platforms, LMS software, and e-learning tools for educators and learners.</p>
            ...
            <div className="footer-bottom">
              <p className="footer-copy">© {new Date().getFullYear()} eLearning Tools. All rights reserved.</p>
            </div>
          </div>
        </footer>
