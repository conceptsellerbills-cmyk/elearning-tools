...
const CATEGORIES: { label: string; href: string }[] = [{"label":"📚 Online Courses","href":"/category/online-courses"},{"label":"🏫 LMS Software","href":"/category/lms"},{"label":"📝 Video Platforms","href":"/category/video-platforms"},{"label":"📝 Quiz & Testing","href":"/category/assessment"},{"label":"🏆 Certifications","href":"/category/certifications"},{"label":"🤖 AI for Learning","href":"/category/ai-learning"},{"label":"📚 Course Creation","href":"/category/course-creation"},{"label":"🌍 Language Learning","href":"/category/language-learning"},{"label":"💻 Coding Bootcamps","href":"/category/coding-bootcamps"},{"label":"🖥️ Virtual Classroom","href":"/category/virtual-classroom"},{"label":"📡 Webinar Platforms","href":"/category/webinars"},{"label":"🃏 Flashcard Apps","href":"/category/flashcards"},{"label":"💡 Skill Development","href":"/category/skill-development"},{"label":"👨‍🏫 Online Tutoring","href":"/category/tutoring"},{"label":"⚡ Microlearning","href":"/category/microlearning"},{"label":"🏢 Corporate Training","href":"/category/corporate-training"},{"label":"🔬 EdTech Tools","href":"/category/edtech-tools"},{"label":"👥 Learning Communities","href":"/category/learning-community"},{"label":"🎨 Instructional Design","href":"/category/instructional-design"},{"label":"🎧 Audio Learning","href":"/category/audio-learning"}];
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      description: post.description || "",
      type: "article",
      url: `https://www.elearning-tools.com/${slug}`,
      siteName: "eLearning Tools",
    ...
    alternates: { canonical: `https://www.elearning-tools.com/${slug}` },
  };
}
...
export default async function ArticlePage({ params }: Props) {
  ...
  const schema = JSON.stringify({
    ...
    url: `https://www.elearning-tools.com/${slug}`,
    mainEntityOfPage: { "@type": "WebPage", "@id": `https://www.elearning-tools.com/${slug}` },
    author: { "@type": "Organization", name: "eLearning Tools", url: "https://www.elearning-tools.com" },
    publisher: {
      "@type": "Organization",
      name: "eLearning Tools",
      url: "https://www.elearning-tools.com",
      logo: { "@type": "ImageObject", url: "https://www.elearning-tools.com/logo.png", width: 200, height: 60 }
    },
    keywords: post.keyword || "",
  });
  ...
  const breadcrumbSchema = JSON.stringify({
    ...
    "@type": "BreadcrumbList",
    itemListElement: [
      { "@type": "ListItem", position: 1, name: "Home", item: "https://www.elearning-tools.com" },
      ...(post.category ? [{ "@type": "ListItem", position: 2, name: post.category.replace(/-/g, " ").replace(/\b\w/g, (l: string) => l.toUpperCase()), item: `https://www.elearning-tools.com/category/${post.category}` }] : []),
      { "@type": "ListItem", position: post.category ? 3 : 2, name: post.title, item: `https://www.elearning-tools.com/${slug}` },
    ],
  });
    ...
    <>
      <style>{`
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        :root{--bg:#060d1a;--surface:#111520;--border:#1e2535;--text:#e4e8f4;--muted:#7a82a0;--accent:#3b82f6;--radius:10px}
          ...
          <article className="article">
            ...
            <div className="author-box">
              ...
              <div className="author-info">
                <div className="author-name">eLearning Tools Editorial Team</div>
