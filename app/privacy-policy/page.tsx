...
export const metadata: Metadata = { title: "Privacy Policy — eLearning Tools", description: "Privacy Policy for eLearning Tools (elearning-tools.com)." };
...
`}</style>
      <div className="page-wrap">
        ...
        <p>Welcome to eLearning Tools ("we", "us", or "our"), accessible at elearning-tools.com. This Privacy Policy explains how we collect, use, and protect your information when you visit our website.</p>
        ...
        <h2>6. Your Rights</h2>
        <p>You have the right to access, correct, or delete your personal data. To exercise these rights, contact us at <a href="mailto:hello@elearning-tools.com">hello@elearning-tools.com</a>.</p>
        ...
        <h2>9. Contact</h2>
        <p>For privacy-related questions, contact us at <a href="mailto:hello@elearning-tools.com">hello@elearning-tools.com</a>.</p>
      </div>
    </>
  );
}
