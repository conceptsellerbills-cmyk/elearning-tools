...
export const metadata: Metadata = { title: "Contact — eLearning Tools", description: "Get in touch with the eLearning Tools team." };
...
`}</style>
      <div className="page-wrap">
        ...
        <div className="info-card">
          ...
          <p>For faster responses, email us at <a href="mailto:hello@elearning-tools.com">hello@elearning-tools.com</a>. We reply within 1–2 business days.</p>
        </div>
