...
export const metadata: Metadata = { title: "Cookie Policy — eLearning Tools", description: "Cookie Policy for eLearning Tools (elearning-tools.com)." };
...
`}</style>
      <div className="page-wrap">
        ...
        <h2>Contact</h2>
        <p>If you have questions about our cookie use, contact us at <a href="mailto:hello@elearning-tools.com">hello@elearning-tools.com</a>.</p>
      </div>
    </>
  );
}
