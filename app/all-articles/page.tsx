...
export const metadata: Metadata = {
  title: "All Articles — eLearning Tools",
  description: "Browse every article published on eLearning Tools.",
};
    ...
    <>
      <style>{`
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .aa-eyebrow{font-size:0.72rem;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;color:#3b82f6;margin-bottom:8px}
        ...
        .aa-card{background:#0c1422;border:1px solid #1e2535;border-radius:12px;overflow:hidden;display:flex;flex-direction:column;transition:border-color 0.15s,transform 0.15s}
        .aa-card:hover{border-color:#3b82f6;transform:translateY(-2px)}
        ...
        .aa-tag{display:inline-block;font-size:0.68rem;font-weight:700;letter-spacing:0.07em;text-transform:uppercase;color:#3b82f6;background:#3b82f618;border:1px solid #3b82f630;padding:3px 10px;border-radius:20px;margin-bottom:12px;width:fit-content}
        .aa-card-title{font-size:0.98rem;font-weight:700;line-height:1.4;margin-bottom:8px;color:#e4e8f4}
        .aa-card-title:hover{color:#3b82f6}
        ...
        .aa-read{font-size:0.82rem;font-weight:600;color:#3b82f6}
