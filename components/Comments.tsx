  ...
  return (
    <>
      <style>{`
        ...
        .comments-heading{font-size:0.72rem;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;color:#3b82f6;margin-bottom:6px}
        ...
        .comment-avatar{width:32px;height:32px;border-radius:50%;background:linear-gradient(135deg,#3b82f655,#3b82f622);display:flex;align-items:center;justify-content:center;font-size:0.85rem;font-weight:700;color:#3b82f6;flex-shrink:0}
        ...
        .comment-name-input:focus,.comment-body-input:focus{border-color:#3b82f6}
        ...
        .comment-submit{background:#3b82f6;color:#fff;border:none;border-radius:8px;padding:11px 28px;font-size:0.9rem;font-weight:700;cursor:pointer;transition:opacity 0.15s}
